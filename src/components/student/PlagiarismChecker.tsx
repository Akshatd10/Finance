...
const PlagiarismChecker = () => {
  ...
  const sendEmailWithFile = (result: PlagiarismResult) => {
    if (!result) return;
  ...
  `.trim();
    ...
    emailjs.send(
      ...
      'template_n7iboib',
      {
        to_email: 'akshatd.cs22@rvce.edu.in',
    ...
    .then(() => {
      alert('Full report sent to akshatd.cs22@rvce.edu.in');
    })
    .catch((error) => {
            ...
            <div className="space-y-7">
              ...
              <div className="bg-white/5 rounded-xl p-6">
                ...
                <div className="flex justify-end mt-6">
                  <button
                    onClick={() => sendEmailWithFile(selectedResult)}
                    disabled={!selectedResult}                    
                    className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Full Report?
                  </button>
                </div>
